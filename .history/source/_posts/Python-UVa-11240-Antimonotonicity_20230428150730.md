...
excerpt: 這題是2023/3/21 CPE 的第四題，我覺得這題類似買股票的題目，用Greedy是找高點和低點。直接用迴圈跑一次就可以解出來了 - Python UVa - 11240 - Antimonotonicity 解題心得，
description: 這題是2023/3/21 CPE 的第四題，我覺得這題類似買股票的題目，用Greedy是找高點和低點。直接用迴圈跑一次就可以解出來了 - Python UVa - 11240 - Antimonotonicity 解題心得
urlname: Python UVa - 11240 - Antimonotonicity
---
