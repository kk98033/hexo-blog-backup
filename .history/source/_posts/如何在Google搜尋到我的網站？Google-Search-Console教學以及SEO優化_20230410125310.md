...
1. [Free XML Sitemap](https://www.mysitemapgenerator.com/) ，用法很簡單，打上你網站的**根目錄**網址，選擇**XML Sitemap**(預設的那個)，再點擊 **GO TO CREATION**即可，接下來按下 **START** ，系統就會開始爬你的網站，等到他爬完後點擊下載。
   
2. [https://www.xml-sitemaps.com/](https://www.xml-sitemaps.com/)
