...
{% img ./如何在Google搜尋到我的網站？Google-Search-Console教學以及SEO優化/site.png '"site:iddle.dev示範" "site:iddle.dev示範"' %}
...
{% img  https://blog.iddle.dev/public/2023/03/13/test-post/test_img.png '"ai generated image" "alt text"' %}
