...
{% img [class names] source/_drafts/如何在Google搜尋到我的網站？Google-Search-Console教學以及SEO優化/site.png [512] [512] '"site://iddle.dev示範" "site://iddle.dev示範"' %}


對於剛上線運作的網站，Google 可能不知道有這個網站存在，要等到 Google 的爬蟲爬到你的網站可能會需要很多的時間。
那麼要如何快速的讓 Google 知道你網站的存在呢？我們可以藉助[Google Search Console](https://search.google.com/search-console/about)來手動要求 Google 的爬蟲來爬你的網站